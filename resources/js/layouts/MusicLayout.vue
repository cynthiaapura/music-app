        ...
        <div class="relative flex h-16 items-center justify-between">
          <div class="flex flex-1 items-center justify-center sm:items-center sm:justify-start">
            <div class="flex flex-shrink-0 items-center">
              <Link :href="route('test')" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300">
                <img class="h-20 w-auto" src="/spotify.svg" alt="Your Company" />
              </Link>
            </div>
            <div class="hidden sm:ml-6 sm:block">
              <div class="flex space-x-4">
                <Link
                  ...
                  class="rounded-md px-3 py-3 text-sm font-medium"
